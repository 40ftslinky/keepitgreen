...
;(function (window, document, undefined) {
	...
	var getValidityState = function (field) {
		...
		// Run validity checks
		var checkValidity = {
			badInput: (isNum && ((type === 'tel')) && length > 0 && !/[-+]?[0-9]/.test(field.value)), // value of a number field is not a number and type is 'tel'
...
window.displayMailChimpStatus = function (data) {
	...
	// redirect on submit + "success"
	// if(data.result != 'error') {
	// 	setTimeout(function() {
	// 		window.location.href = 'https://omgcreative.com.au/thank-you';
	// 	}, 2000);
  // }
	if(data.result != 'error') {
